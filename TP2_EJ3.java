        ...
        do{
            ...
            switch(op){
                case 1: System.out.println("Primer numerador: ");
                        ...
                        break;
                case 2: System.out.println(Racional.Suma(r1, r2).Simplificar()); break;
                case 3: System.out.println(Racional.Resta(r1, r2).Simplificar()); break;
                case 4: System.out.println(Racional.Multiplicar(r1, r2).Simplificar()); break;
                case 5: System.out.println(Racional.Dividir(r1, r2).Simplificar()); break;
                case 6: System.out.println("Suma: " + r1.Suma(r2).Simplificar() + "\nResta: " + r1.Resta(r2).Simplificar() + "\nMultiplicacion: " + r1.Multiplicar(r2).Simplificar() + "\nDivision: " + r1.Dividir(r2).Simplificar()); break;
                case 7: System.out.println("El Decimal de " + r1.getNum() + "/" + r1.getDen() + " es: " + r1.aDecimal() + "\nEl Decimal de " + r2.getNum() + "/" + r2.getDen() + " es: " + r2.aDecimal()); break;
                case 8: if(r1.Simplificar().equals(r2.Simplificar())) System.out.println("Son iguales");
                        else System.out.println("Son distintos");
                        break;
                case 9: System.out.println("r1: " + r1.toString() + "\nr2: " + r2.toString()); break;
                case 10: System.out.println("El mcd entre " + r1.toString() + " y " + r2.toString() + " es: " + Racional.MCD(r1.getDen(),r2.getDen())); break;
            }
